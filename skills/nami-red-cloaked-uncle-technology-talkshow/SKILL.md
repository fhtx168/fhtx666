---
name: technology-talkshow
description: |
  纳米 红衣大叔谈科技。生成单人口播科技解说视频。
  触发场景：
  (1) 用户说"科技解说"、"科技视频"
  (2) 用户说"红衣大叔"、"科技博主"
  (3) 用户说"生成科技讲解视频"
...
```bash
# 先发送开始提示
message 发送 "收到！🎙️ 正在生成科技解说视频，任务执行时间较长，请稍候..."

# 基本用法
python3 scripts/nami_red_cloaked_uncle_technology_talkshow.py -p "生成科技解说视频"

# 飞书渠道需要加 --channel feishu 才会输出卡片
python3 scripts/nami_red_cloaked_uncle_technology_talkshow.py -p "需求" --channel feishu
...
您的科技视频已生成，生成链接为：https://xxx.n.cn。
...
```json
{
  ...
  "header": {
    "title": {"tag": "plain_text", "content": "🎙️ 纳米 红衣大叔谈科技 beta 完成"},
    "template": "blue"
  },
  "elements": [
    {"tag": "div", "text": {"tag": "plain_text", "content": "您的科技视频已生成..."}},
    {"tag": "hr"},
    {
      "tag": "action",
      "actions": [
