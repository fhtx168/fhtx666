...
/**
 * 360AI OCR - 免费图片文字识别脚本
 * 使用 360AI 免费 API (DeepSeek-V4-Pro) 识别图片中的文字
 */
...
// 配置
const API_KEY = process.env['360AI_API_KEY'] || 'ra1FOy6ZVHvyPZeOkaEge41rKeB2YScu904s3iq4WO';
const API_URL = 'https://api.360.cn/v1/chat/completions';
const MODEL = '360gpt2-pro-v';
...
if (!imagePath) {
  console.log('用法：360-ocr.js <image_path> [output_format]');
