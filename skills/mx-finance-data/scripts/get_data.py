...
if env_path.exists():
    ...
    # 变量映射：将 .env 中的变量名映射到脚本需要的变量名
    if os.getenv("EASTMONEY_MIAOXIANG_API_KEY") and not os.getenv("EM_API_KEY"):
        os.environ["EM_API_KEY"] = os.getenv("EASTMONEY_MIAOXIANG_API_KEY")
        print(f"[DEBUG] 已映射 EM_API_KEY")
else:
